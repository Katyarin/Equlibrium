...
for ind in range(len(time_list)):
    ...
    li = 1
    #alf11, alf22 = 1.5, 1
    li_f, li_f2, res = Globus_PET.find_par2('li', Shotn, time, I_coil, betta_I, li, [50, 190, 10], False)
    li_prob = int(li_f2 * 100)
    li_acc, li_acc2, res_acc = Globus_PET.find_par2('li', Shotn, time, I_coil, betta_I, li, [li_prob - 10, li_prob + 10, 1], False, 'all')
