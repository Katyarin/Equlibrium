...
tomorow = '230207'
start_time = 0.15 #defolt 0, s

#shot_list = [41809, 41813, 41820, 41859, 41863, 41865, 41866, 41867, 42089]
shot_list = [42529]
for Shotn in shot_list:
    ...
    for ind in range(index_start, index_end):
        ...
        '''_______________________IPF2 from comb______________________'''
        #I_coil = Globus_PET.get_coils(Shotn, time, path='/pf2_from_sht/')
        ...
        min_count = 0
        min_delta = 100
        while psi_delta > 0.0005 or bounds_delta > 0.002:
            if attempt % 2:
